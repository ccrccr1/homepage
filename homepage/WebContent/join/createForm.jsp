...
<jsp:include page="/menu/top.jsp"/>
	<div class="container">
		<h2 class="col-sm-offset-2 col-sm-10">회원가입</h1>
		<label class="col-sm-offset-2 col-sm-10">(<span id="need" style="color:red;">*</span>필수입력사항)</label>
		<form class="form-horizontal" action="preProc.jsp"method="post" name="frm" onsubmit="return incheck(this)" enctype="multipart/form-data">
			<div class="form-group">
				<label class="control-label col-sm-2" for="fname">사진</label>
				<div class="col-sm-6">
					<input type="file" accept=".jpg,.gif,.png" class="form-control" id="fname" name="fname">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="password" name="passwd" id="passwd" placeholder="Enter 비밀번호"  class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="repasswd"><span id="need">*</span>비밀번호 확인</label>
				<div class="col-sm-4">
					<input type="password" name="repasswd" id="repasswd" class="form-control" placeholder="Password Check">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="jname"><span	id="need">*</span>이름</label>
				<div class="col-sm-4">
					<input type="text" name="jname" id="jname" class="form-control" placeholder="Enter 이름">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="tel"><span id="need">*</span>전화번호</label>
				<div class="col-sm-4">
					<input type="text" name="tel" id="tel" class="form-control" placeholder="Enter 전화번호">
				</div>
			</div>
			<div class="form-group">
				...
				<button type="button" onclick="emailCheck(document.frm.email.value)" class="btn col-sm-2">Email 중복확인</button>
